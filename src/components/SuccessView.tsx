...
export default function SuccessView({ orderId, quantity, totalPrice, orderDetails, onReset }: SuccessViewProps) {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white border border-gray-100 rounded-3xl shadow-xl overflow-hidden mt-6 animate-fade-in">
      {/* Top Header Card */}
      <div className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white p-8 text-center flex flex-col items-center gap-3 relative">
        {/* Animated Celebration check */}
        <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center border-2 border-emerald-300 shadow-inner">
      ...
      <div className="p-6 flex flex-col gap-6">
        ...
        <div className="bg-emerald-50/40 border border-emerald-100 rounded-2xl p-4 text-center">
          ...
          <p className="text-xs text-emerald-700 font-bold mt-1.5 flex items-center justify-center gap-1">
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border-2 border-emerald-500/20 rounded-2xl p-4.5 flex flex-col gap-3 relative overflow-hidden shadow-sm">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 bg-emerald-500 text-white rounded-full flex items-center justify-center font-bold shadow-md shrink-0 animate-pulse">
              <MessageCircle className="w-5 h-5 fill-white" />
            </div>
            <div>
              <h4 className="font-black text-emerald-950 text-sm leading-tight">Join Our Official WhatsApp Group!</h4>
              <p className="text-emerald-800 text-[11px] leading-relaxed mt-1 font-semibold">
          ...
          <a
            ...
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-black py-3 px-5 rounded-xl text-xs tracking-wide uppercase transition-all flex items-center justify-center gap-2 shadow-md hover:-translate-y-0.5 active:translate-y-0"
          >
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative border-l-2 border-emerald-100 ml-4.5 pl-5 py-1 flex flex-col gap-5">
            {/* Step 1 */}
            <div className="relative">
              <span className="absolute -left-[27px] top-0 w-4 h-4 rounded-full bg-emerald-600 border-2 border-white ring-4 ring-emerald-100 flex items-center justify-center" />
              <div>
        ...
        <div className="bg-gray-50 rounded-2xl p-4.5 border border-gray-150 flex flex-col gap-2.5 text-xs">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-emerald-700 font-extrabold">{orderDetails.productName} (Qty: {quantity})</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2.5">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-black py-4 px-6 rounded-2xl flex items-center justify-center gap-2 transition-all shadow-md active:scale-98 text-sm tracking-wide"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200 font-extrabold py-3 px-6 rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-98 text-xs"
          >
